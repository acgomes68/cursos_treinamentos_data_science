...
def test_is_python_27():
    major = sys.version_info.major
    minor = sys.version_info.minor
    if major == 2:
        pass
    else:
        print("You are running Python {}, but we need Python {}.".format(major, 2))
        print("Download and install the Anaconda distribution for Python 2.")
        print("Stopping here.")

        # Let's stop here
        sys.exit(1)
        return None
        # assert major == 2, "Stopping here - we need Python 2."

    if minor >= 7:
        print("Testing Python version-> py{}.{} OK".format(major, minor))
    else:
        print("Warning: You should be running Python 2.7 or newer, " +
